...
const CONFIG = {
  ...
  sharePointSite: 'https://bcgov.sharepoint.com/teams/12320-ConnectedServicesStrategicPriority',
  listName: 'Weekly SitRep Data',
  coordListName: 'SitRep Coordinator',
}

const TEAMS = [
  'BCSC', 'EFV', 'SDG', 'ADR', 'CHEFS', 'Notify', 'Workflow',
  'DDS', 'SDX', 'DevX', 'CSTAR', 'Disability Services', 'SSI', 'SDPR/SDD', 'ACT',
]
...
let saveTimer = null    // debounce timer for coordinator saves
